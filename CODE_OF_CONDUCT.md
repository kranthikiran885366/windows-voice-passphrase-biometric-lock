...
* Focusing on what is best not just for us as individuals, but for the
  overall community
* Using professional language and maintaining security best practices
* Respecting the sensitive nature of biometric security systems
...
* Attempting to bypass or compromise security mechanisms
* Sharing biometric data or authentication credentials
* Other conduct which could reasonably be considered inappropriate in a
  professional setting

## Security-Specific Guidelines

Given the sensitive nature of this biometric authentication system:

* **Never share authentication credentials** or biometric data
* **Report security vulnerabilities** responsibly through proper channels
* **Respect privacy** - do not attempt to extract or reverse-engineer biometric templates
* **Follow responsible disclosure** for any security issues discovered
* **Maintain confidentiality** of any sensitive system information
* **Use the developer fail-safe mechanism** only for legitimate emergencies
...
For security-related violations or vulnerabilities:
